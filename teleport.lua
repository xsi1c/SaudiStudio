...
local function createFrame()
    ...
    titleText.Text = "TP Saver [by: xsi1c]"
    ...
    healthInput.PlaceholderText = "Enter Health % for auto-tp"
    ...
    teleportToolButton.MouseButton1Click:Connect(function()
        ...
        handle.BrickColor = BrickColor.new("Sky blue")
        handle.Material = Enum.Material.Neon
        handle.Transparency = 1 -- Make the handle invisible
        tool.Active = false -- Disable tool animations
...
local dragInputIcon, startPosIcon
...
game:GetService("UserInputService").InputChanged:Connect(function(input)
    if draggingIcon and input == dragInputIcon then
